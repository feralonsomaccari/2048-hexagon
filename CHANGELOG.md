...
- Purist achievement no longer unlocks on boards that have no power-ups.

## [0.26.2] - 2026-06-02

### Fixed
- Vertically centered the hexagon glyph in the title.
...
### Fixed
- Fixed sounds not playing in iOS Safari.
